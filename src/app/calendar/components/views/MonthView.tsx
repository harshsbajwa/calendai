...
const MonthView: React.FC<MonthViewProps> = ({
  ...
  return (
    <div className={cn(
      ...
      <div className="custom-scrollbar bg-border/50 dark:bg-dark-border/30 grid flex-1 grid-cols-7 gap-px overflow-y-auto [grid-auto-rows:minmax(1fr,auto)]">
        {days.map((day) => {
          ...
          return (
            <div
              key={day.toISOString()}
              className={cn(
                "relative flex min-h-[90px] cursor-pointer flex-col p-1.5 transition-colors duration-150 group",
                isCurrentMonth
                ...
                !isCurrentMonth && "text-muted-foreground/70 dark:text-dark-muted-foreground/70",
            ...
            >
              <time
                ...
                className={cn(
                  ...
                  isToday(day) &&
                    isCurrentMonth &&
                    "bg-primary text-primary-foreground font-semibold group-hover:bg-primary/80",
                  !isToday(day) &&
                    isSameDay(day, currentDate) &&
                    isCurrentMonth &&
                    "bg-accent/50 dark:bg-accent/30 text-accent-foreground ring-primary/50 ring-1 ring-inset group-hover:bg-accent/80",
                   ...
                   {dayEvents.slice(0, maxEventsToShow).map((event) => (
                     <button
                       ...
                       className={cn(
                         ...
                         "shadow-md hover:shadow-lg transform hover:scale-[1.03] perspective-1000"
                       )}
