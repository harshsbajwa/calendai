  ...
  return (
    <aside
      ...
      className={cn(
        ...
        "bg-glass-pane isolate ring-1 ring-black/5 backdrop-blur-[12px] backdrop-saturate-150",
        "my-3 rounded-tl-2xl rounded-bl-2xl",
              ...
              <div className="space-y-3">
                {agendaEvents.map((event) => (
                  <Tooltip key={event.id} delayDuration={300}>
                    ...
                    <TooltipContent
                      side="left"
                      className="bg-popover/90 dark:bg-dark-popover/90 backdrop-blur-sm"
                    >
