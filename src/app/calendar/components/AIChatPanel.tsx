...
export function AIChatPanel({ isExpanded }: AIChatPanelProps) {
  const {
    messages,
    input,
    handleInputChange,
  ...
  return (
    <div className="flex h-full flex-col bg-transparent">
      <div className="border-border/50 flex h-16 flex-shrink-0 items-center justify-between px-4 py-2 my-1.5">
        <h2 className="dream-text sm:text-4xl text-2xl">
          Chat
        </h2>
        {messages.length > 0 && (
          <Button
